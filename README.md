...
>[!NOTE]
>Use the / (forward slash) key as a productivity shortcut. Pressing / instantly moves the cursor to the search bar, so you can start typing without using the mouse.
